...
class EventBus:
    ...
    async def publish_population_tick(self, generation: int, population_size: int, 
    ...
    async def publish_trace_chunk(self, generation: int, trace_data: List[Dict[str, Any]]):
    ...
    async def publish_help_score(self, brain_id: int, help_score: float, 
                               help_type: str, target_id: Optional[int] = None):
    ...
    async def publish_growth_event(self, brain_id: int, growth_type: str, 
    ...
    async def publish_lineage_update(self, brain_id: int, parent_id: Optional[int], 
                                   mutation_type: str, fitness_delta: float):
