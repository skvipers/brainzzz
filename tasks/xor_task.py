...
class XORTask(BaseTask):
    ...
    def __init__(self):
        super().__init__(name="XOR", difficulty=0.3)
        self.description = (
            "Задача XOR: классифицировать входные данные по правилу исключающего ИЛИ"
        )
        self.input_size = 2
        self.output_size = 1
    ...
    def evaluate_solution(
        ...
        for input_data, expected_output in test_data:
            ...
            except Exception:  # Убираем неиспользуемую переменную 'e'
    ...
    def __repr__(self):
        return (
            f"XORTask(difficulty={self.difficulty:.2f}, "
