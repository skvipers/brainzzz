...
class SequenceTask(BaseTask):
    ...
    def __init__(self, sequence_length: int = 3):
        ...
        self.description = f"Задача с последовательностями длиной {sequence_length}: запомнить и воспроизвести паттерн"
    ...
    def __repr__(self):
        return f"SequenceTask(difficulty={self.difficulty:.2f}, length={self.sequence_length}, test_cases={len(self._test_data)})" 