...
class Selection:
    ...
    def set_strategy(self, strategy: str):
        ...
        if strategy in valid_strategies:
            ...
            raise ValueError(f"Неизвестная стратегия: {strategy}. Доступные: {valid_strategies}")
    ...
    def set_tournament_size(self, size: int):
        ...
        if size > 0:
            ...
            raise ValueError("Размер турнира должен быть положительным")
    
    def __repr__(self):
        return f"Selection(strategy={self.strategy}, tournament_size={self.tournament_size})" 