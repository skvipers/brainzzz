...
class EvolutionEngine:
    ...
    def get_evolution_statistics(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'fitness_improvement': (self.best_fitness_history[-1] - self.best_fitness_history[0]) if len(self.best_fitness_history) > 1 else 0.0,
    ...
    def __repr__(self):
        return (f"EvolutionEngine(pop_size={self.population_size}, "
