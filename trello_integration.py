...
try:
    ...
    print("💡 Для автоматической загрузки .env файла установите: pip install python-dotenv")
...
class TrelloClient:
    ...
    def create_card(self, list_id: str, name: str, desc: str = "", due: str = None, labels: List[str] = None) -> Dict:
...
def main():
    ...
    try:
        ...
        if not board_id:
            ...
            choice = input("\nВыберите доску (номер), введите ID доски, или 0 для создания новой: ").strip()
