...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[logging.FileHandler("brain_incubator.log"), logging.StreamHandler()],
    )
...
def run_evolution_cycle(
    ...
    for generation in range(num_generations):
        ...
        if max_fitness > 0.95:
            logging.info(
                "Достигнута высокая приспособленность! Останавливаем эволюцию."
            )
            break
...
def main():
    ...
    try:
        ...
        # Движок эволюции
        evolution_engine = EvolutionEngine(
            population_size=10, mutation_rate=0.1, crossover_rate=0.7, elite_size=2
        )
